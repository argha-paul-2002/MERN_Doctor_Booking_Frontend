        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className='md:col-span-2'>
            <div className="flex items-center gap-5">
              ...
              <div>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded' >Surgron</span>
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Jhon Walker</h3>
                ...
                <p className='text__para text text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
